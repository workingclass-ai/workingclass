...
这个仓库收录服务于劳动者的 Claude Code skills 和工具。第一个，也是核心的，是 **劳动者AI助手 / Laborer's Companion**——一个帮你看穿职场话术、做出对自己最好的决定的工具。
...
然后在 Claude Code 里描述你的职场情况，skill 会自动激活。或者用 slash 命令：
